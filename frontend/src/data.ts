export const EVENTS_DATA = [
  ...
  {
    // We moved the expensive one back to ID 2 so it matches the blockchain
    id: 2,
  ...
  },
  {
    ...
    // We are using ID 7 because that is the "Cheap" event you created on the blockchain
    id: 7,
    title: 'GitHub Project Demo',
    date: 'TODAY • LIVE',
