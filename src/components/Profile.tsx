    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50/30 to-white pt-32 pb-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center">
                <span className="text-3xl text-amber-900">L</span>
              </div>
              <div>
                <h1 className="text-4xl mb-2 text-gray-900">My Collection</h1>
                <div className="flex items-center gap-3">
                  <p className="text-gray-500 font-mono">0x7f2a...a3b2</p>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-gray-100">
              <p className="text-sm text-gray-500 mb-2">Total Passes</p>
              <p className="text-3xl text-gray-900">3</p>
            </div>
            <div className="p-6 rounded-2xl bg-white border border-gray-100">
              <p className="text-sm text-gray-500 mb-2">Events Attended</p>
        ...
        <Tabs defaultValue="owned" className="w-full">
          <TabsList className="w-full justify-start rounded-full bg-gray-100 p-1 mb-8">
            <TabsTrigger value="owned" className="rounded-full px-8">Owned</TabsTrigger>
            <TabsTrigger value="attended" className="rounded-full px-8">Attended</TabsTrigger>
            <TabsTrigger value="activity" className="rounded-full px-8">Activity</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="owned">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {ownedTickets.map((ticket, index) => (
                ...
                >
                  <div className="rounded-2xl overflow-hidden bg-white border border-gray-100 hover:shadow-xl transition-all">
                    {/* Ticket Card */}
                    <div className="relative h-64 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
                      ...
                      <div className="relative h-full p-6 flex flex-col justify-between">
                        <div className="flex justify-between items-start">
                          <span className="px-3 py-1 rounded-full bg-amber-400/20 backdrop-blur-sm text-amber-300 text-xs">
                            {ticket.tokenId}
                          </span>
                          <button className="w-8 h-8 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <QrCode className="w-4 h-4 text-white" strokeWidth={1.5} />
                          </button>
                        </div>

                        <div>
                          <h3 className="text-xl text-white mb-3">{ticket.name}</h3>
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-300">{ticket.date}</span>
                            <span className="text-gray-400">{ticket.location}</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <motion.div
                ...
                className="rounded-2xl border-2 border-dashed border-gray-200 hover:border-amber-300 hover:bg-amber-50/50 transition-all cursor-pointer flex items-center justify-center min-h-[340px]"
              >
                <div className="text-center p-8">
                  <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mx-auto mb-4">
                    <span className="text-2xl text-gray-400">+</span>
                  </div>
                  <p className="text-gray-900 mb-2">Mint More Passes</p>
                  <p className="text-sm text-gray-500">Explore upcoming events</p>
                </div>
              </motion.div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="attended">
            <div className="text-center py-20">
              ...
              <p className="text-xl text-gray-900 mb-2">1 Event Attended</p>
