    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50/30 to-white pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h1 className="text-5xl mb-4 text-gray-900">Upcoming Events</h1>
          <p className="text-xl text-gray-500">Discover and mint your next exclusive experience</p>
        </motion.div>
        ...
        >
          <div className="flex-1 relative">
            ...
            <Input
              ...
              className="pl-12 h-12 rounded-full border-gray-200 bg-white"
            />
          </div>
          <Button
            variant="outline"
